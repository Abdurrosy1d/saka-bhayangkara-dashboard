...
const Sidebar = ({ children, id, title, menuList }: ManagerProp) => {
  ...
  return (
    <div className="w-full min-h-dvh bg-orange-400">
      ...
      {/* sidebar section */}
      <div
        className={`flex flex-col w-2/3 md:w-1/2 lg:w-1/4 h-full fixed 
        top-0 right-full transition-transform z-50
      ...
      >
          ...
          <button onClick={() => setIsShow(false)}>
            ...
            >
              <path
                ...
                4.5M21 12a9 9 0 1 1-18 0 9 9 0 
                1 1 18 0Z"
              />
            </svg>
          </button>
        ...
        {/* user section */}
        <div className="w-full mt-10 mb-6 bg-primary text-gray-500 p-3 flex gap-2 items-center">
          <Image
            src={Profile}
            alt="Profile"
            width={40}
